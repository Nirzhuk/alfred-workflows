...
- Every mark, including the unknown-provider fallback, sits on the same always-white card. Recolor a mark when needed so it stays legible on that white tile without changing its identity.
